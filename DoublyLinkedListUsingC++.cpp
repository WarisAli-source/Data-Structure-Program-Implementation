...
class Node{
	...
	public:
		...
		Node* previous;  //pointer to previous
...
class DoublyLinkedList{
	...
	public:
		Node* head;   //Pointer of head in LinkedList
	...
	//5. Deleting A node  by Unique key . Basically De Link the Node
